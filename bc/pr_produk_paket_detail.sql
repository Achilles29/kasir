...
CREATE TABLE `pr_produk_paket_detail`  (
  ...
  INDEX `paket_id`(`pr_produk_paket_id`) USING BTREE,
  INDEX `pr_produk_id`(`pr_produk_id`) USING BTREE,
  CONSTRAINT `pr_produk_paket_detail_ibfk_1` FOREIGN KEY (`pr_produk_paket_id`) REFERENCES `pr_produk_paket` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
