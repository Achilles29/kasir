...
-- ----------------------------
-- Table structure for bl_purchase_kitchen
-- ----------------------------
...
CREATE TABLE `bl_purchase_kitchen`  (
  ...
  CONSTRAINT `bl_purchase_kitchen_ibfk_1` FOREIGN KEY (`kategori_id`) REFERENCES `bl_kategori` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `bl_purchase_kitchen_ibfk_2` FOREIGN KEY (`tipe_produksi_id`) REFERENCES `bl_tipe_produksi` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
