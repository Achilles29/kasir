...
<body>
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                res.items.forEach(function(item) {
                    var row = `<tr data-id="${item.pr_produk_id}" data-detail-id="${item.id}">
                    ...
                    <td>
                        ...
                        <ul class="list-extra" data-produk-id="${item.pr_produk_id}"></ul>
                    </td>
    ...
    //     if (!selectedOrderId) {
    //         alert("Tidak ada transaksi yang sedang diubah.");
    //         return;
    //     }
