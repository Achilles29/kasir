<div class="container">
    ...
    <!-- Form Filter -->
    <form method="GET" action="<?= base_url('stokterbuang') ?>" class="form-inline mb-3">
    ...
    <!-- Form Input -->
<form method="POST" action="<?= base_url('stokterbuang/add') ?>">
...
<table class="table table-bordered">
    ...
    <tbody>
        <?php $no = 1; ?>
        <?php foreach ($stok_terbuang as $row): ?>
            <tr>
                <td><?= $no++ ?></td>
                <td><?= $row['tanggal'] ?></td>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="editForm" method="post" action="<?= base_url('stokterbuang/update') ?>">
            <input type="hidden" name="id" id="editId">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel">Edit Stok Terbuang</h5>
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="deleteForm" method="post" action="<?= base_url('stokterbuang/delete') ?>">
...
<script>
    document.getElementById('cari-barang').addEventListener('input', function () {
        ...
        if (keyword.length > 0) {
            fetch('<?= base_url('StokTerbuang/search_barang') ?>?keyword=' + encodeURIComponent(keyword))
