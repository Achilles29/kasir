<div class="container-fluid">
    ...
    <form method="GET" action="<?= base_url('purchase_bar/history') ?>" class="form-inline mb-3">
        ...
        <tbody>
            <?php foreach ($history as $index => $item): ?>
                <tr>
                    ...
                    <td>
                        <a href="<?= base_url('purchase_bar/detail/' . $item['id']) ?>" class="btn btn-info btn-sm">Detail</a>
                    </td>
