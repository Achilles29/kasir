...
<div class="container-fluid">
    ...
    <form class="mb-3" method="post" action="<?= base_url('purchase_bar/add') ?>">
        <div class="row g-3">
            <div class="col-md-4">
...
<form method="GET" action="<?= base_url('purchase_bar/index') ?>" class="form-inline mb-3">
                ...
                <tbody>
                     <?php $no = 1; foreach ($purchases as $purchase): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('purchase_bar/edit/' . $purchase['id']) ?>" class="btn btn-warning btn-sm">Edit</a>
                                <a href="<?= base_url('purchase_bar/delete/' . $purchase['id']) ?>" class="btn btn-danger btn-sm">Hapus</a>
                                <?php if ($purchase['status'] === 'pending'): ?>
                                    <a href="<?= base_url('purchase_bar/verify/' . $purchase['id']) ?>" class="btn btn-success btn-sm">Verifikasi</a>
                                    <a href="<?= base_url('purchase_bar/reject/' . $purchase['id']) ?>" class="btn btn-danger btn-sm">Tolak</a>
                                <?php endif; ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
...
document.getElementById('cari-nama-barang').addEventListener('input', function () {
    ...
    if (keyword.length > 0) {
        fetch(`<?= base_url('purchase_bar/search_barang') ?>?keyword=${encodeURIComponent(keyword)}`)
