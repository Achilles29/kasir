    ...
    <div class="col-md-2">
        <div class="card shadow-sm border-0 border-bottom border-success border-3">
            <div class="card-body text-center">
                ...
                <div class="text-success fs-6 fw-bold">Rp <?= number_format($total_penjualan, 0, ',', '.') ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-2">
        <div class="card shadow-sm border-0 border-bottom border-info border-3">
            <div class="card-body text-center">
                ...
                <div class="text-info fs-6 fw-bold">Rp <?= number_format($penjualan_bersih, 0, ',', '.') ?>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-2">
        <div class="card shadow-sm border-0 border-bottom border-purple border-3">
            <div class="card-body text-center">
                ...
                <div class="text-purple fs-6 fw-bold">Rp <?= number_format($total_pembayaran, 0, ',', '.') ?>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-2">
        <div class="card shadow-sm border-0 border-bottom border-warning border-3">
            <div class="card-body text-center">
                ...
                <div class="text-warning fs-6 fw-bold">Rp <?= number_format($total_piutang, 0, ',', '.') ?>
                </div>
            </div>
        </div>
    </div>
