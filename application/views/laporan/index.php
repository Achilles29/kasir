  ...
  <div class="row g-2 align-items-end">
    ...
    <div class="col-md-4 col-lg-4">
      ...
      <div class="input-group">
        ...
        <input type="text" name="search" id="searchInput" class="form-control" placeholder="Cari transaksi...">
      </div>
    </div>
    ...
    <div class="col-md-3 col-lg-3">
      ...
      <input type="date" name="tanggal_awal" class="form-control" value="<?= $tanggal_awal ?? date('Y-m-d') ?>">
    </div>
        ...
        <div class="modal-body row">
          <div class="col-md-4 border-end">
            <ul class="nav flex-column nav-pills">
              <li class="nav-item"><a class="nav-link active" data-bs-toggle="pill" href="#statusBayar">Status Pembayaran</a></li>
              <li class="nav-item"><a class="nav-link" data-bs-toggle="pill" href="#jenisOrder">Jenis Order</a></li>
            </ul>
          </div>
          <div class="col-md-8">
...
$(function () {
  ...
  $('#filterForm').on('submit', function (e) {
    ...
    $.ajax({
      ...
      data: $(this).serialize(),
      beforeSend: () => {
        $('#dataTransaksi').html('<div class="text-center text-muted py-5">Memuat data...</div>');
      },
      success: (res) => {
        $('#dataTransaksi').html(res);
      },
      error: () => {
        $('#dataTransaksi').html('<div class="text-center text-danger py-5">Gagal memuat data.</div>');
      }
    });
  });
