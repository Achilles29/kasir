...
<div class="container-fluid">
    ...
    <div id="dataTransaksi">
        <?php $this->load->view('laporan/laporan_penjualan_tabel_transaksi', ['transaksi' => $transaksi]); ?>
    </div>
        ...
        transaksi.forEach(t => {
            html += `
                <tr>
                    ...
                    <td><a href="<?= base_url('laporan/laporan_penjualan_detail/') ?>${t.id}" class="btn btn-sm btn-outline-primary">
