...
class Purchase_bar extends CI_Controller {
    ...
    public function index() {
        ...
        $data['title'] = 'Purchase Order Bar';

        // Default values for dropdowns
        $data['default_jenis_pengeluaran'] = 2; // Default ID untuk jenis pengeluaran
        ...
        $config['base_url'] = base_url('purchase_bar/index');
        $config['total_rows'] = $this->PurchaseBar_model->count_filtered($tanggal_awal, $tanggal_akhir);
        ...
        $data['purchases'] = $this->PurchaseBar_model->get_all($tanggal_awal, $tanggal_akhir, $per_page, $page);
    ...
    public function add() {
        ...
        $this->PurchaseBar_model->insert($insert_data);
    ...
    public function verify($id) {
        $pendingData = $this->PurchaseBar_model->get_by_id($id);
    ...
    public function history() {
        ...
        $data['history'] = $this->PurchaseBar_model->get_history($tanggal_awal, $tanggal_akhir);
        $data['tanggal_awal'] = $tanggal_awal;
        $data['tanggal_akhir'] = $tanggal_akhir;
        $data['per_page'] = $per_page;

        $this->load->view('templates/header', $data);
        $this->load->view('purchase_bar/history', $data);
        $this->load->view('templates/footer');
    }
...
public function detail($id) {
    ...
    $data['purchase'] = $this->PurchaseBar_model->get_full_detail($id);

    if (!$data['purchase']) {
        $this->session->set_flashdata('error', 'Data tidak ditemukan.');
        redirect('purchase_bar/history');
    }

    $this->load->view('templates/header', $data);
    $this->load->view('purchase_bar/detail', $data);
    $this->load->view('templates/footer');
}


public function edit($id) {
    $data['title'] = 'Edit Purchase Order Bar';

    // Ambil data berdasarkan ID
    $data['purchase'] = $this->PurchaseBar_model->get_by_id($id);
    ...
    // Load view
    $this->load->view('templates/header', $data);
    $this->load->view('purchase_bar/edit', $data);
    $this->load->view('templates/footer');
}
...
public function update($id) {
    ...
    $this->PurchaseBar_model->update($id, $update_data);
